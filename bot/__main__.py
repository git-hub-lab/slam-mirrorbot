...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, search, delete, speedtest, usage, mediainfo, count, config, updates, tamilyogi
...
'''
    ...
    buttons.buildbutton("VarnaX", "https://varnax.varnax.workers.dev/")
    buttons.buildbutton("The X Lovers", "https://thexlovers.thexlovers.workers.dev/")
...
BotCommand(f'{BotCommands.TamilyogiCommand}','Mirror Tamilyogi support link'),
BotCommand(f'{BotCommands.TarTamilyogiCommand }','Mirror Tamilyogi link as tar'),
